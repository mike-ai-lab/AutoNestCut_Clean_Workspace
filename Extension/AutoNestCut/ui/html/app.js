...
function displayMaterials() {
    ...
    materialEntries.forEach(entry => {
        ...
        const materialNameStyle = isAutoCreated 
          ? 'background: #fff3cd; color: #856404; padding: 4px 8px; border-radius: 4px; border: 1px solid #ffc107;'
          : '';
        
        const autoGeneratedBadge = isAutoCreated 
        ...
        tr.innerHTML = `
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a;">
                <div style="display: flex; align-items: center; flex-wrap: wrap;">
                    <input type="text" value="${escapeHtml(material)}" onchange="updateMaterialName(this, '${escapeHtml(material)}')" style="flex: 1; min-width: 200px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; font-weight: 600; color: #007cba; ${materialNameStyle}" title="${isAutoCreated ? 'Auto-created material' : 'Material name'}">
                    ${autoGeneratedBadge}
                </div>
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: right; font-family: 'Courier New', monospace; font-size: 13px;">
                <input type="number" value="${formatDimension(width)}" onchange="updateMaterialProperty(this, '${escapeHtml(material)}', 'width')" style="width: 80px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; text-align: right;">
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: right; font-family: 'Courier New', monospace; font-size: 13px;">
                <input type="number" value="${formatDimension(height)}" onchange="updateMaterialProperty(this, '${escapeHtml(material)}', 'height')" style="width: 80px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; text-align: right;">
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: right; font-family: 'Courier New', monospace; font-size: 13px;">
                <input type="number" value="${formatDimension(thickness)}" onchange="updateMaterialProperty(this, '${escapeHtml(material)}', 'thickness')" style="width: 80px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; text-align: right;">
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: right; font-family: 'Courier New', monospace; font-size: 13px;">
                <input type="number" value="${data.density || 600}" step="1" onchange="updateMaterialProperty(this, '${escapeHtml(material)}', 'density')" style="width: 80px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; text-align: right;">
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: right; font-family: 'Courier New', monospace; font-size: 13px;">
                <input type="number" value="${parseFloat(price).toFixed(2)}" step="0.01" onchange="updateMaterialProperty(this, '${escapeHtml(material)}', 'price')" style="width: 100px; padding: 6px 8px; border: 1px solid #d0d7de; border-radius: 4px; font-size: 13px; text-align: right;">
            </td>
            <td style="padding: 14px 16px; border-bottom: 1px solid #e1e5e9; color: #1a1a1a; text-align: center;">
                <div style="display: flex; gap: 6px; justify-content: center;">
                    ...
                    <button class="action-btn delete" style="background: white; border: 1px solid #d0d7de; color: #1a1a1a; width: 32px; height: 32px; border-radius: 4px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s; padding: 0;" title="Delete" onclick="removeMaterial('${escapeHtml(material)}')">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function displayPartsPreview() {
    ...
    Object.keys(partsData).forEach(material => {
        ...
        parts.forEach(part => {
            ...
            tr.onclick = function() {
                selectPart(this, part.name, part.width, part.height, part.thickness);
            };
            
            const area = (part.width * part.height) / areaFactors[currentAreaUnits];
            
            // Check if material is auto-generated
